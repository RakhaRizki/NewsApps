...
import com.rakha.example.finalnewsapp.databinding.FragmentCnnTechBinding
...
class CnnTechFragment : Fragment() {
    private lateinit var binding: FragmentCnnTechBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commonViewModel.getCnnTechNews()
        commonViewModel.CnnTechNews.observe(viewLifecycleOwner) { newsResponse ->
