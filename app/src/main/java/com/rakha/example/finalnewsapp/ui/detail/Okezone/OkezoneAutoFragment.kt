...
import com.rakha.example.finalnewsapp.databinding.FragmentOkezoneAutoBinding
import com.rakha.example.finalnewsapp.ui.NewsViewModel
import com.rakha.example.finalnewsapp.utils.NewsViewModelFactory

class OkezoneAutoFragment : Fragment() {
    private lateinit var binding: FragmentOkezoneAutoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOkezoneAutoBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commonViewModel.getOkezoneAutoNews()
        commonViewModel.OkezoneAutoNews.observe(viewLifecycleOwner) { newsResponse ->
